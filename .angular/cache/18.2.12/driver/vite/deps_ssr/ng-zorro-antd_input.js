...
var NzInputDirective = class _NzInputDirective {
  ...
  constructor(renderer, elementRef, hostView, directionality) {
    ...
    this.disabled$ = new import_rxjs2.Subject();
    this.dir = "ltr";
  ...
  ngOnInit() {
    ...
    if (this.ngControl) {
      this.ngControl.statusChanges?.pipe((0, import_operators.filter)(() => this.ngControl.disabled !== null), (0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
...
var NzInputGroupComponent = class _NzInputGroupComponent {
  ...
  ngAfterContentInit() {
    ...
    const listOfInputChange$ = this.listOfNzInputDirective.changes.pipe((0, import_operators.startWith)(this.listOfNzInputDirective));
    listOfInputChange$.pipe((0, import_operators.switchMap)((list) => (0, import_rxjs2.merge)(...[listOfInputChange$, ...list.map((input) => input.disabled$)])), (0, import_operators.mergeMap)(() => listOfInputChange$), (0, import_operators.map)((list) => list.some((input) => input.disabled)), (0, import_operators.takeUntil)(this.destroy$)).subscribe((disabled) => {
...
var NzAutosizeDirective = class _NzAutosizeDirective {
  ...
  ngAfterViewInit() {
    if (this.autosize && this.platform.isBrowser) {
      ...
      this.resizeService.subscribe().pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(() => this.resizeToFitContent(true));
    }
  }
  ngOnDestroy() {
...
var NzTextareaCountComponent = class _NzTextareaCountComponent {
  constructor(renderer, elementRef) {
    ...
    this.configChange$ = new import_rxjs2.Subject();
    this.destroy$ = new import_rxjs2.Subject();
  }
  ngAfterContentInit() {
    ...
    if (this.nzInputDirective.ngControl) {
      const valueChanges = this.nzInputDirective.ngControl.valueChanges || import_rxjs2.EMPTY;
      (0, import_rxjs2.merge)(valueChanges, this.configChange$).pipe((0, import_operators.takeUntil)(this.destroy$), (0, import_operators.map)(() => this.nzInputDirective.ngControl.value), (0, import_operators.startWith)(this.nzInputDirective.ngControl.value)).subscribe((value) => {
