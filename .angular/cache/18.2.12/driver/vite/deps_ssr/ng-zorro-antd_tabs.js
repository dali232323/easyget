...
var NzTabScrollListDirective = class _NzTabScrollListDirective {
  ...
  ngOnInit() {
    this.unsubscribe = this.ngZone.runOutsideAngular(() => {
      ...
      const wheel$ = (0, import_rxjs3.fromEvent)(el, "wheel");
      const touchstart$ = (0, import_rxjs3.fromEvent)(el, "touchstart");
      const touchmove$ = (0, import_rxjs3.fromEvent)(el, "touchmove");
      const touchend$ = (0, import_rxjs3.fromEvent)(el, "touchend");
      const subscription = new import_rxjs3.Subscription();
...
var RESIZE_SCHEDULER = typeof requestAnimationFrame !== "undefined" ? import_rxjs3.animationFrameScheduler : import_rxjs3.asapScheduler;
...
var NzTabNavBarComponent = class _NzTabNavBarComponent {
  ...
  ngAfterViewInit() {
    const dirChange = this.dir ? this.dir.change.asObservable() : (0, import_rxjs3.of)(null);
    ...
    (0, import_rxjs3.merge)(this.nzResizeObserver.observe(this.navWarpRef), this.nzResizeObserver.observe(this.navListRef)).pipe((0, import_operators2.takeUntil)(this.destroy$), (0, import_operators2.auditTime)(16, RESIZE_SCHEDULER)).subscribe(() => {
      realign();
    });
    (0, import_rxjs3.merge)(dirChange, resize, this.items.changes).pipe((0, import_operators2.takeUntil)(this.destroy$)).subscribe(() => {
      Promise.resolve().then(realign);
      this.keyManager.withHorizontalOrientation(this.getLayoutDirection());
    });
    this.keyManager.change.pipe((0, import_operators2.takeUntil)(this.destroy$)).subscribe((newFocusIndex) => {
...
var NzTabComponent = class _NzTabComponent {
  constructor() {
    ...
    this.stateChanges = new import_rxjs3.Subject();
  }
  get content() {
...
var NzTabSetComponent = class _NzTabSetComponent {
  ...
  constructor(nzConfigService, ngZone, cdr, directionality) {
    ...
    this.tabLabelSubscription = import_rxjs3.Subscription.EMPTY;
    this.tabsSubscription = import_rxjs3.Subscription.EMPTY;
    this.canDeactivateSubscription = import_rxjs3.Subscription.EMPTY;
  ...
  subscribeToTabLabels() {
    ...
    this.tabLabelSubscription = (0, import_rxjs3.merge)(...this.tabs.map((tab) => tab.stateChanges)).subscribe(() => this.cdr.markForCheck());
  }
  subscribeToAllTabChanges() {
    this.allTabs.changes.pipe((0, import_operators2.startWith)(this.allTabs)).subscribe((tabs) => {
  ...
  canDeactivateFun(pre, next) {
    if (typeof this.nzCanDeactivate === "function") {
      ...
      return observable.pipe((0, import_operators2.first)(), (0, import_operators2.takeUntil)(this.destroy$));
    } else {
      return (0, import_rxjs3.of)(true);
    }
  }
  ...
  setUpRouter() {
    if (this.nzLinkRouter) {
      ...
      this.router.events.pipe((0, import_operators2.takeUntil)(this.destroy$), (0, import_operators2.filter)((e) => e instanceof NavigationEnd), (0, import_operators2.startWith)(true), (0, import_operators2.delay)(0)).subscribe(() => {
